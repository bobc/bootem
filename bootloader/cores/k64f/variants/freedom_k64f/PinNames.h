...
#define GPIO_PORT_MASK  0xff00

#define GPIO_FUNCTION_SHIFT 16
#define GPIO_FUNCTION_MASK  0xff0000

#define GPIO_MODE_SHIFT 24
#define GPIO_MODE_MASK  0xff000000

#define GPIO_PIN_NUM(p) ((p) & GPIO_PIN_MASK)
#define GPIO_PORT(p)    (((p) & GPIO_PORT_MASK) >> GPIO_PORT_SHIFT)

#define GPIO_FUNCTION(p) (((p) & GPIO_FUNCTION_MASK) >> GPIO_FUNCTION_SHIFT)
